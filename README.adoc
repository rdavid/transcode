...
:img-license: https://img.shields.io/github/license/rdavid/transcode?color=94bff3&labelColor=555555&logo=freebsd&logoColor=dcdccc&style=flat
...
:img-rubocop: https://img.shields.io/github/actions/workflow/status/rdavid/transcode/rubocop.yml?branch=master&color=8cd0d3&label=rubocop&labelColor=555555&logoColor=dcdccc&style=flat
